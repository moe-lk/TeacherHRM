...
// var_dump($_REQUEST);
$nicNO = $_REQUEST['id'];
$AppCat = $_REQUEST["TempAppCat"];
$MedApp = $_REQUEST["TempMedApp"];
$SubApp = $_REQUEST["TempSubApp"];
$otherSub = $_REQUEST["TempotherSub"];
$state = '0';
$SQL1 = "SELECT TOP(1)
*
FROM
...
$sql = "UPDATE [dbo].[Temp_AppoinmentDetails]
SET [AppCategory] = ?
   ,[AppSubject] = ?
   ,[Medium] = ?
   ,[SchoolType] = ?
...
WHERE NIC = '$nicNO'";
    ...
    $params = array($AppCat, $SubApp, $MedApp, $SchType, $otherSub, $NICUser, $state, $dateNow);
