                                ...
                                <div class="containerHeaderOne">
                                    ...
                                    <?php if($pageid != 0) {?>
                                        <div class="productsAreaRight">
                                            ...
                                            <li <?php if($pageid==1 || $pageid==0){?>class="active"<?php }?>><a href="personalInfo-1--<?php echo $id ?>.html">Personal Info</a></li>
                                            <li <?php if($pageid==2 || $pageid==3){?>class="active"<?php }?>><a href="familyInfo-2--<?php echo $id ?>.html">Family Info</a></li>
                                            <li <?php if($pageid==4){?>class="active"<?php }?>><a href="qualifications-4--<?php echo $id ?>.html">Qualifications</a></li>
                                            <li <?php if($pageid==5){?>class="active"<?php }?>><a href="teaching-5--<?php echo $id ?>.html">Teaching</a></li>
                                            <li <?php if($pageid==8){?>class="active"<?php }?>><a href="services-8--<?php echo $id ?>.html">Services</a></li>
                                            <li <?php if($pageid==6){?>class="active"<?php }?>><a href="coordinatorsList-6--<?php echo $id ?>.html">Coordinator List</a></li>
                                            <?php if($_SESSION["accLevel"]=='1000' || $_SESSION["accLevel"]=='3000'){?>
                                            <li <?php if($pageid==7){?>class="active"<?php }?>><a href="Inquiry-7--<?php echo $id ?>.html">Inquiry</a></li><?php }?> 
                                            <li <?php if($pageid==6){?>class="active"<?php }?>><a href="printProfile.php?userN=<?php echo $id ?>&tpe=PRINT&uom" target="_blank">Print</a></li>

                                            <li <?php if($pageid==9){?>class="active"<?php }?>><a href="change_password-9--<?php echo $id ?>.html">Change Password</a></li>
                                            <li <?php if($pageid==30){?>class="active"<?php }?>><a href="teaching1-1--<?php echo $id ?>.html">Teaching1</a></li></ul>
<div id="geographical" class="contenttab" style="padding-top:20px;"></div>
                                ...
                                <?php //echo $pageid;
                                if($pageid==0){include('teacherList.php');
                                }if($pageid==1){include('personalInfo.php');
                                }if ($pageid==2){include('familyInfo.php');
                                }/* if ($pageid==9){include('familyInfo_2.php');
                                }*/if ($pageid==3){include('familyInfoChild.php');
                                }if ($pageid==4){include('qualifications.php');}
                                if ($pageid==5){include('teaching.php');}
                                if ($pageid==6){include('coordinatorsList.php');}
                                if($pageid==7){include('inquiry.php');}
                                if($pageid==8){include('services_min.php');}
                                if($pageid==9){include('changePassword.php');}
                                if($pageid==30){include('Teaching12.php');}
?>
                                </div>
