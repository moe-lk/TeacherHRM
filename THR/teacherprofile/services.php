        ...
        <div class="mcib_middle1">
            <table width="945" cellpadding="0" cellspacing="0">
                ...
                while ($rowABC = sqlsrv_fetch_array($resABC, SQLSRV_FETCH_ASSOC)) {
                    ...
                    $ServiceRecTypeCodeCheck = trim($rowABC['ServiceRecTypeCode']);
                    
                    if($ServiceRecTypeCodeCheck==$serviceNA){
                        continue;
                    }
                    if($ServiceRecTypeCodeCheck=="NA01"){
                        $serviceNA = $ServiceRecTypeCodeCheck;
                    }
...
<?php if ($menu == 'E' || $menu == 'U') { ?>
  ...
  order by InstitutionName";
                            ...
                            <td width="50%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                                    <tr>
                                        <td width="38%" align="left" valign="top"><strong>Reference Number</strong></td>
                                        <td width="3%" align="left" valign="top"><strong>:</strong></td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top"><strong><span class="red"><strong>*</strong></span><strong></strong>Effective Date</strong></td>
                                        <td align="left" valign="top"><strong>:</strong></td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top"><strong><span class="red"><strong>*</strong></span><strong></strong>Service Grade</strong></td>
                                        <td align="left" valign="top"><strong>:</strong></td>
