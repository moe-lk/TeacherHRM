...
<div class="main_content_inner_block">
    <form method="post" action="Inquiry-7--<?php echo $id ?>.html" name="frmSave" id="frmSave" enctype="multipart/form-data" onSubmit="return check_form(frmSave);">
  ...
  $i=1;
   $stmt = $db->runMsSqlQuery($sqlList);
                      ...
                      <tr>
                        ...
                        <td bgcolor="#FFFFFF" align="center"><a href="<?php echo "$ttle-$pageid-$Expr1-$id.html";?>">View</a></td>
                        <td bgcolor="#FFFFFF" align="center"><a href="javascript:aedWin('<?php echo $Expr1 ?>','D','','<?php echo $tblNam ?>','<?php echo "$ttle-$pageid--$id.html";?>')">Delete <?php //echo $Expr1 ?></a></td>
                      </tr>
                      <?php }?>
                      <tr>
