...
FROM            TG_StaffLeave INNER JOIN
						 ...
						 where TG_StaffLeave.NIC='$NICUser'";//$NICUser
...
if(isset($_POST["FrmSubmit"])){	
	...
	//exit();
		$queryGradeSave="INSERT INTO $tblNam
			   (NIC,ServiceRecRef,LeaveType,StartDate,EndDate,LastUpdate,UpdateBy,Reference,RecordLog,NoofDays,AttachFile,IsApproved,ApplyBy)
		 VALUES
			   ('$NIC','$ServiceRecRef','$LeaveType','$StartDate','$EndDate','$LastUpdate','$UpdateBy','$Reference','$RecordLog','$NoofDays','$fileSaveName','$IsApproved','$ApplyBy')";
