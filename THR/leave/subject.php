...
if(isset($_POST["FrmSubmit"])){	
	...
	$queryGradeSave="INSERT INTO $tblNam
           (SchoolID,GradeID,SubjectID,PeriodsPerWeek)
     VALUES
           ('$SchoolID','$GradeID','$SubjectID','$PeriodsPerWeek')";
...
<div class="main_content_inner_block">
  ...
  FROM [dbo].[CD_Subject] order by SubjectName";
                    ...
                    <tr>
                      ...
                      <td><input name="PeriodsPerWeek" type="text" class="input3" id="PeriodsPerWeek" /></td>
                    </tr>
                    <tr>
                      <td>&nbsp;</td>
                ...
                <tr>
                    <td colspan="2" bgcolor="#CCCCCC"><table width="100%" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="10%" align="center" bgcolor="#999999">Grade</td>
                        <td width="26%" align="center" bgcolor="#999999">Subject</td>
                        <td width="14%" align="center" bgcolor="#999999">Periods Per Week</td>
                        <td width="9%" align="center" bgcolor="#999999">Delete</td>
                      </tr>
                      <?php 
					  
					  $sqlList="SELECT        CD_CensesNo.CenCode, TG_SchoolGrade.ID, CD_CensesNo.InstitutionName, TG_SchoolGrade.GradeTitle, CD_Subject.SubjectName, TG_SchoolSubjectMaster.PeriodsPerWeek,
