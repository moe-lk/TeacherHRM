...
// get all parent menu records for looged user
                    ...
                    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                        ...
                        if($rowid==74){
                            $url = "myprofileTCH/personalInfo-1--".$NICUser.".html";
                        }
                        ?>
                ...
                <table width="1000px">
                    ...
                    if ($accessRoleType == "NC" || $accessRoleType == "MO") {
                        ...
                        $ZONECODE = null;
                        $Division = null;
                        echo "<td><h2>Total No. of Schools in National Level</h2></td>";
                        echo "<td><h2>Total No. of Teachers in National Level</h2></td>";
                    }
                    ...
                    if ($accessRoleType == "PD"){
                        $sqlPD = "SELECT TeacherMast.NIC, StaffServiceHistory.InstCode, CD_CensesNo.InstitutionName, CD_CensesNo.DivisionCode, CD_CensesNo.ZoneCode, CD_CensesNo.DistrictCode, CD_Provinces.ProCode, CD_Provinces.Province 
                            ...
                            while ($rowPD = sqlsrv_fetch_array($stmtPD)) {
                                ...
                                $Division = null;
                                $SCType = null;
                                echo "<td><h2>Total No. of Schools in ".$rowPD['Province']." Province</h2></td>";
                                echo "<td><h2>Total No. of Teachers in ".$rowPD['Province']." Province</h2></td>";
                            }  
                    }
                    if ($accessRoleType == "ZN") {
                        ...
                        while ($rowPD = sqlsrv_fetch_array($stmtPD)) {
                            ...
                            $Division = null;
                            $SCType = null;
                            echo "<td><h2>Total No. of Schools in ".$rowPD['Zone']." Zone</h2></td>";
                            echo "<td><h2>Total No. of Teachers in ".$rowPD['Zone']." Zone</h2></td>";
                        }
                    }
                    $params1 = array(
                    ...
                    // var_dump($ProCode);
                    // $sql = "{call SP_GetDashboardFor_LoggedUser( ?, ?, ?, ?, ?)}";
                    ...
                    <tr>
                        <td>
                            <h3>National Schools: </h3>
                        </td>
                        <td>
                            <h3>National School teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h3>Provincial Schools: </h3>
                        </td>
                        <td>
                            <h3>Provincial School teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h3>Private Aided Schools: </h3>
                        </td>
                        <td>
                            <h3>Private Aided School teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h3>Private Un-Aided Schools: </h3>
                        </td>
                        <td>
                            <h3>Private Un-Aided School teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h3>Pirivena teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <h3>Special Education Schools: </h3>
                        </td>
                        <td>
                            <h3>Special Education School teachers: </h3>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <h3>Education Institution teachers: </h3>
                        </td>
                    </tr>
                </table>
                </div>
