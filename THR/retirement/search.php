...
if($_SESSION['loggedAccessLevel']=='1000' || $_SESSION['loggedAccessLevel']=='3000') {
	header("Location: services-8--$nicNO.html") ;
	exit() ;
}
...
if (isset($_POST["FrmSubmit"])) {
	...
	if($nicNOsrch!=''){
		...
		if($isAvailable==1){
			header("Location: retirementList-1--$nicNOsrch.html") ;
			exit() ;
		}else{
	...
	if($msg==''){
	//if($accLevel=='1000'){
		header("Location:retirementList-1.html");
