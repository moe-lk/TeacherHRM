...
<div class="main_content_inner_block">
    <div class="mcib_middle1" style="width: 500px; margin-left: 220px; font-weight: bold;">
        <form method="post" action="retirementSearchSuport.php" name="frmSave" id="frmSave" enctype="multipart/form-data" onSubmit="return check_form(frmSave);">
            <table width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td colspan="2" align="center" valign="top" class="errormsg"><?php echo $_SESSION["ses_expire"];
$_SESSION["ses_expire"] = "";
echo $msg; ?></td>
                </tr>
                <tr>
