...
if (isset($_POST["hidquerySave"])) {
  ...
  Query
FROM TG_QuerySave
WHERE (NIC = N'$nicNO') AND (QueryName = N'$queryName')";
...
WHERE (ID = $saveQID) AND (GeoCoulmName = N'ST')";
        $stmt = $db->runMsSqlQuery($sql);
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="productsItemBoxText">
                                                            <table width="800" border="0" bgcolor="#2D65A0" id="tblMainQuliDetails" cellpadding="3" cellspacing="1">
                                                                ...
                                                                <?php
                                                                if ($querySaveVal != "") {
                                                                    $sql = "SELECT CD_Qualif.Description
FROM            TG_QuerySaveQualification INNER JOIN
                         CD_Qualif ON TG_QuerySaveQualification.QualificationValue = CD_Qualif.Qcode
WHERE        (TG_QuerySaveQualification.ID = '$saveQID')";
                                                    ...
                                                    <li>
                                                        ...
                                                        <div class="productsItemBoxText">
                                                            ...
                                                            <table width="850" border="0" bgcolor="#2D65A0" id="tblMainServiceDetails" cellpadding="3" cellspacing="1">
                                                                ...
                                                                <?php
                                                                if ($querySaveVal != "") {
                                                                    $sql = "SELECT        CD_Positions.PositionName, CD_Service.ServiceName
FROM            TG_QuerySaveService INNER JOIN
                         CD_Positions ON TG_QuerySaveService.Code = CD_Positions.Code INNER JOIN
                         CD_Service ON TG_QuerySaveService.ServCode = CD_Service.ServCode
WHERE        (TG_QuerySaveService.ID = '$saveQID')";
