...
WHERE (s.NIC <> N'')";
    ...
    $html.="<div style=\"text-align:center; height:200px; width:auto;\"><p style=\"font-size:28px; font-weight:600;\">Ministry of Education Sri Lanka<br>Education Management Information System </p><p style=\"font-size:20px; font-weight:600;\">". $txtRptHedding ."<br>Detail Report&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" . date('Y-m-d H:i:s') . "</p></div>";
