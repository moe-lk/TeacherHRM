...
if (isset($_POST["FrmSubmit"])) {
    ...
    if ($msg == "") {
        ...
        if ($ServiceRecTypeCode == "NA01") {
            ...
            $AppDateF = $AppDate;
            $InstCodeF = $InstCode;
            $SecGRCodeF = $SecGRCode;
            $WorkStatusCode = $WorkStatusCode;
            $ServiceTypeCodeF = $ServiceTypeCode;

            $PositionCodeF = $PositionCode;
            $Cat2003CodeF = $Cat2003Code;
        }
        ...
        $queryMainSave = "INSERT INTO ArchiveUP_StaffServiceHistory
			 ...
			 VALUES
				   ('$NIC','$ServiceRecTypeCodeF','$AppDateF','$InstCodeF','$SecGRCodeF','$WorkStatusCode','$ServiceTypeCodeF','$EmpTypeCode','$PositionCodeF','$Cat2003CodeF','register','$UpdateBy','$dateU','register')";
        ...
        $queryCurrentSave = "INSERT INTO ArchiveUP_StaffServiceHistory			   (NIC,ServiceRecTypeCode,AppDate,InstCode,SecGRCode,WorkStatusCode,ServiceTypeCode,EmpTypeCode,PositionCode,Cat2003Code,Reference,UpdateBy,LastUpdate,RecordLog)
			 VALUES
				   ('$NIC','$ServiceRecTypeCode','$AppDate','$InstCode','$SecGRCode','$WorkStatusCode','$ServiceTypeCode','$EmpTypeCode','$PositionCode','$Cat2003Code','register','$UpdateBy','$dateU','register')";
...
<body onLoad="<?php echo $curser ?>">
                        ...
                        <tr>
                            <td colspan="2" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                                    <tr>
                                        ...
                                        <td width="22%" align="left" valign="top">Date of Appointment</td>
                                        <td width="1%" align="left" valign="top"><strong>:</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">Teaching Section <span class="form_error_sched">*</span></td>
                                        <td align="left" valign="top"><strong>:</strong></td>
                                    ...
                                    <tr>
                                        <td align="left" valign="top">School/Institution Name <span class="form_error_sched">*</span></td>
                                        <td align="left" valign="top">:</td>
  ...
  order by InstitutionName";
                                        ...
                                        <td align="left" valign="top">Service Category <span class="form_error_sched">*</span></td>
                                        <td align="left" valign="top"><strong>:</strong></td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="top">Category as per 01/2016 circular <span class="form_error_sched">*</span></td>
                                        <td align="left" valign="top"><strong>:</strong></td>
  ...
  order by InstitutionName";
                                    ...
                                    <tr>
                                        <td align="left" valign="top">Employment Basis1</td>
                                        <td align="left" valign="top">:</td>
                                        ...
                                        <td align="left" valign="top">Category as per 01/2016 circular</td>
                                        <td align="left" valign="top"><strong>:</strong></td>
                        ...
                        <tr>
                            <td valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                                    ...
                                    <tr>
                                        <td colspan="2"><span class="form_error"><strong>- Inquiry is being processed at the zonal level.</strong></span></td>
                                    </tr>
                                    <tr>
                                        <td width="32%">&nbsp;</td>
        ...
        <script>
            ...
            $("#frmSave").submit(function (event) {//alert('hi');
                ...
                if (NIC != "") {
                    if (NIC.length == 10) {//alert('xx'); alert(NIC);
