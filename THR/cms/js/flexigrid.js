	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
			...
			populate: function () { //get latest data
				...
				var param = {page:p.newp, rp: p.rp, sortname: p.sortname, sortorder: p.sortorder, query: p.query, qtype: p.qtype, extraparam: p.extraparam};
			...
			for (i in p.buttons)
				{
					...
					if (!btn.separator)
					{
						...
						if(btn.bclass == "add"){
							btnDiv.className = 'fbutton1';
							btnDiv.innerHTML = "<div style='float:right'><span>"+btn.name+"</span></div>";
						}else{
							btnDiv.className = 'fbutton';
							btnDiv.innerHTML = "<div style='float:left'><span>"+btn.name+"</span></div>";
						}
						if (btn.bclass) 
							...
							if(btn.bclass == "add"){
								$('span',btnDiv)
								.addClass(btn.bclass)
								.css({paddingLeft:25, float:'right'});
							}else{
								$('span',btnDiv)
								.addClass(btn.bclass)
								//.css({paddingLeft:20});
...
/*@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@*/				
		...
		if (p.title)
		{
			...
			//remove title bar - editing lakmal -2011.12.13
			$(g.gDiv).prepend(g.mDiv);
			if (p.showTableToggleBtn)
				{
					//$(g.mDiv).append('<div class="ptogtitle" title="Minimize/Maximize Table"><span></span></div>');
					//remove $(g.mDiv) to avoid Minimize/Maximize Table 2011.12.11
					/*
