                    ...
                    <div class="midRightBox"><!-- midRightBox -->
                        <form id="login" name="login" action="login.php?request=signIn" method="POST">
                            <div class="midRightInnerBox">
								...
								<div class="midRightInnerBoxTitel" style="margin-top:5px; color:#C03; font-size:12px;">
								<?php if(isset($_SESSION['error_msg'])) {echo $_SESSION['error_msg']; $_SESSION['error_msg'] = "";} ?></div><?php } ?>
                                ...
                                <div class="midLinkText" style="margin-bottom:5px;"><strong>Forgot your password?</strong><br>
                                    <a href="#">Contact your Zonal NEMIS coordinator to reset your password.</a></div>
                            </div>
                        </form>
