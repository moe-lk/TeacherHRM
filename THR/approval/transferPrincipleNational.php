...
$approvSql="SELECT        TG_PrincipleTransferNational.TransferType, TG_PrincipleTransferNational.ID, TG_PrincipleTransferNational.TransferRequestType, TG_PrincipleTransferNational.ExpectSchool, 
                         TG_PrincipleTransferNational.LikeToOtherSchool, TG_PrincipleTransferNational.ReasonForTransfer, TG_PrincipleTransferNational.ExtraActivities, CONVERT(varchar(20),TG_PrincipleTransferNational.RequestedDate,121) AS RequestedDate, 
                         TG_PrincipleTransferNational.IsApproved, TG_Request_Approve.RequestType, TG_Request_Approve.ApprovelUserNIC, TG_Request_Approve.ApproveUserNominatorNIC, 
                         TeacherMast.SurnameWithInitials, CD_CensesNo.InstitutionName, TG_Request_Approve.ApprovedStatus
FROM            TG_PrincipleTransferNational INNER JOIN
                         TG_Request_Approve ON TG_PrincipleTransferNational.ID = TG_Request_Approve.RequestID INNER JOIN
                         TeacherMast ON TG_PrincipleTransferNational.NIC = TeacherMast.NIC INNER JOIN
                         CD_CensesNo ON TG_PrincipleTransferNational.SchoolID = CD_CensesNo.CenCode
WHERE        (TG_Request_Approve.RequestType = 'TransferPrincipleNational') AND (TG_Request_Approve. $tblField = N'$NICUser') AND 
...
FROM            TG_PrincipleTransferNational
WHERE        (ID = '$id')";
			...
			while ($row = sqlsrv_fetch_array($stmtTr, SQLSRV_FETCH_ASSOC)) {
				...
				$NIC=$row['NIC'];
				$ExpectSchool2=trim($row['ExpectSchool2']);
				$ExpectSchool3=trim($row['ExpectSchool3']);
				$ExpectSchool4=trim($row['ExpectSchool4']);
				$ExpectSchool5=trim($row['ExpectSchool5']);
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
			  ...
			  <tr>
			    <td colspan="2" ><table width="100%" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      <td width="22%" bgcolor="#F7E2DD">Request Type :</td>
                      <td width="78%" bgcolor="#EDEEF3"><?php if($TransferRequestType=="WZ")echo "Within the zone";
...
FROM            TG_SchoolGrade INNER JOIN
                    ...
                    <tr>
                      ...
                      <td bgcolor="#EDEEF3"><?php echo $requestedSchool2; ?></td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#F7E2DD">Expect School 3:</td>
                      <td bgcolor="#EDEEF3"><?php echo $requestedSchool3; ?></td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#F7E2DD">Expect School 4:</td>
                      <td bgcolor="#EDEEF3"><?php echo $requestedSchool4; ?></td>
                    </tr>
                    <tr>
                      <td valign="top" bgcolor="#F7E2DD">Expect School 5:</td>
                      <td bgcolor="#EDEEF3"><?php echo $requestedSchool5; ?></td>
                    </tr>
                    <tr>
...
WHERE        (TG_Request_Approve.RequestType = 'TransferPrincipleNational') AND (TG_Request_Approve.RequestID = '$id')
...
WHERE        (TG_SchoolTeacherTypeWise.SchoolID = '$SchoolID')";
                    ...
                    <tr>
                      ...
                      <input type="hidden" value="TransferPrincipleNational" name="cat" />
