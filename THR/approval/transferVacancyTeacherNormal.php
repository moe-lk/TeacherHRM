...
//$nicNO='722381718V';
$approvSql="SELECT        TG_TeacherVacancyNormal.ID, TG_TeacherVacancyNormal.VacancyMasterID, TG_TeacherVacancyNormal.NIC, TG_TeacherVacancyNormal.ServiceHistoryID, 
                         CONVERT(varchar(20),TG_TeacherVacancyNormal.ApplyDate,121) AS ApplyDate, TG_TeacherVacancyNormal.ExtraActivities, TG_TeacherVacancyNormal.ReasonForTransfer, 
                         TG_TeacherVacancyNormal.IsApproved, TG_TeacherVacancyNormalMaster.Title, CONVERT(varchar(20),TG_TeacherVacancyNormalMaster.OpenDate,121) AS OpenDate , 
                         CONVERT(varchar(20),TG_TeacherVacancyNormalMaster.EndDate,121) AS EndDate, TG_TeacherVacancyNormalMaster.VacancyDescription, TG_TeacherVacancyNormalMaster.SchoolID, 
                         CD_CensesNo.InstitutionName
FROM            TG_TeacherVacancyNormal INNER JOIN
                         TG_TeacherVacancyNormalMaster ON TG_TeacherVacancyNormal.VacancyMasterID = TG_TeacherVacancyNormalMaster.ID INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNormalMaster.SchoolID = CD_CensesNo.CenCode INNER JOIN
                         TG_Request_Approve ON TG_TeacherVacancyNormal.ID = TG_Request_Approve.RequestID
WHERE        (TG_Request_Approve.RequestType = 'VacancyTeacherNormal') AND (TG_Request_Approve.$tblField = N'$NICUser') AND 
