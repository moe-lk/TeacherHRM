...
$approvSql="SELECT        TG_TeacherTransfer.TransferType, TG_TeacherTransfer.ID, TG_TeacherTransfer.TransferRequestType, TG_TeacherTransfer.ExpectSchool, 
                         ...
                         TG_TeacherTransfer.IsApproved, TG_Request_Approve.RequestType, TG_Request_Approve.ApprovelUserNIC, TG_Request_Approve.ApproveUserNominatorNIC, 
...
FROM            TG_TeacherTransfer INNER JOIN
                         TG_Request_Approve ON TG_TeacherTransfer.ID = TG_Request_Approve.RequestID INNER JOIN
                         TeacherMast ON TG_TeacherTransfer.NIC = TeacherMast.NIC INNER JOIN
                         CD_CensesNo ON TG_TeacherTransfer.SchoolID = CD_CensesNo.CenCode
WHERE        (TG_Request_Approve.RequestType = 'TransferTeacherNormal') AND (TG_Request_Approve.$tblField = N'$NICUser') AND 
...
WHERE        (TG_Request_Approve.RequestType = 'TransferTeacherNormal') AND (TG_Request_Approve.RequestID = '$id')
...
WHERE        (TG_SchoolTeacherTypeWise.SchoolID = '$SchoolID')";
                    ...
                    <tr>
                      ...
                      <input type="hidden" value="TransferTeacherNormal" name="cat" />
