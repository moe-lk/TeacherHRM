...
<?php 
$approvetype="VacancyTeacherNational";
...
//$nicNO='722381718V';
$approvSql="SELECT        TG_TeacherVacancyNational.ID, TG_TeacherVacancyNational.VacancyMasterID, TG_TeacherVacancyNational.NIC, TG_TeacherVacancyNational.ServiceHistoryID, 
                         CONVERT(varchar(20),TG_TeacherVacancyNational.ApplyDate,121) AS ApplyDate, TG_TeacherVacancyNational.ExtraActivities, TG_TeacherVacancyNational.ReasonForTransfer, 
                         TG_TeacherVacancyNational.IsApproved, TG_TeacherVacancyNationalMaster.Title, CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.OpenDate,121) AS OpenDate , 
                         CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.EndDate,121) AS EndDate, TG_TeacherVacancyNationalMaster.VacancyDescription, TG_TeacherVacancyNationalMaster.SchoolID, 
                         CD_CensesNo.InstitutionName
FROM            TG_TeacherVacancyNational INNER JOIN
                         TG_TeacherVacancyNationalMaster ON TG_TeacherVacancyNational.VacancyMasterID = TG_TeacherVacancyNationalMaster.ID INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNationalMaster.SchoolID = CD_CensesNo.CenCode INNER JOIN
                         TG_Request_Approve ON TG_TeacherVacancyNational.ID = TG_Request_Approve.RequestID
WHERE        (TG_Request_Approve.RequestType = 'VacancyTeacherNational') AND (TG_Request_Approve.$tblField = N'$NICUser') AND 
...
?>
    ...
    <form method="post" action="transferAction.php" name="frmSave" id="frmSave" enctype="multipart/form-data" onSubmit="return check_form(frmSave);">
		...
		$approvalListSql="SELECT        TG_TeacherVacancyNationalMaster.ID, TG_TeacherVacancyNationalMaster.Title, CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.OpenDate,121) AS OpenDate, CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.EndDate,121) AS EndDate, 
                         TG_TeacherVacancyNationalMaster.VacancyDescription, CD_CensesNo.InstitutionName, CD_CensesNo.IsNationalSchool, CD_CensesNo.CenCode
FROM            TG_TeacherVacancyNationalMaster INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNationalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool='1' and TG_TeacherVacancyNationalMaster.ID='$tpe'";
	...
	$sqlFormDate="SELECT        TG_TeacherVacancyNational.IsApproved, TG_TeacherVacancyNational.ReasonForTransfer, TG_TeacherVacancyNational.ExtraActivities, 
                         TG_TeacherVacancyNational.ApplyDate,  StaffServiceHistory.InstCode, TG_TeacherVacancyNational.NIC, 
                         TG_TeacherVacancyNational.ServiceHistoryID, TG_TeacherVacancyNational.ID
FROM            TG_TeacherVacancyNational INNER JOIN
                         StaffServiceHistory ON TG_TeacherVacancyNational.ServiceHistoryID = StaffServiceHistory.ID
						 where TG_TeacherVacancyNational.ID='$id'";
