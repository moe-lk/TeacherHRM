...
<?php 
$approvetype="VacancyPrincipleNormal";
...
//$nicNO='722381718V';
$approvSql="SELECT        TG_PrincipleVacancyNormal.ID, TG_PrincipleVacancyNormal.VacancyMasterID, TG_PrincipleVacancyNormal.NIC, TG_PrincipleVacancyNormal.ServiceHistoryID, 
                         CONVERT(varchar(20),TG_PrincipleVacancyNormal.ApplyDate,121) AS ApplyDate, TG_PrincipleVacancyNormal.ExtraActivities, TG_PrincipleVacancyNormal.ReasonForTransfer, 
                         TG_PrincipleVacancyNormal.IsApproved, TG_PrincipleVacancyNormalMaster.Title, CONVERT(varchar(20),TG_PrincipleVacancyNormalMaster.OpenDate,121) AS OpenDate , 
                         CONVERT(varchar(20),TG_PrincipleVacancyNormalMaster.EndDate,121) AS EndDate, TG_PrincipleVacancyNormalMaster.VacancyDescription, TG_PrincipleVacancyNormalMaster.SchoolID, 
                         CD_CensesNo.InstitutionName
FROM            TG_PrincipleVacancyNormal INNER JOIN
                         TG_PrincipleVacancyNormalMaster ON TG_PrincipleVacancyNormal.VacancyMasterID = TG_PrincipleVacancyNormalMaster.ID INNER JOIN
                         CD_CensesNo ON TG_PrincipleVacancyNormalMaster.SchoolID = CD_CensesNo.CenCode INNER JOIN
                         TG_Request_Approve ON TG_PrincipleVacancyNormal.ID = TG_Request_Approve.RequestID
WHERE        (TG_Request_Approve.RequestType = 'VacancyPrincipleNormal') AND (TG_Request_Approve.$tblField = N'$NICUser') AND 
...
FROM            TG_PrincipleVacancyNormalMaster INNER JOIN
                         CD_CensesNo ON TG_PrincipleVacancyNormalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool='1' and TG_PrincipleVacancyNormalMaster.ID='$tpe'";
	...
	$sqlFormDate="SELECT        TG_PrincipleVacancyNormal.IsApproved, TG_PrincipleVacancyNormal.ReasonForTransfer, TG_PrincipleVacancyNormal.ExtraActivities, 
                         TG_PrincipleVacancyNormal.ApplyDate,  StaffServiceHistory.InstCode, TG_PrincipleVacancyNormal.NIC, 
                         TG_PrincipleVacancyNormal.ServiceHistoryID, TG_PrincipleVacancyNormal.ID
FROM            TG_PrincipleVacancyNormal INNER JOIN
                         StaffServiceHistory ON TG_PrincipleVacancyNormal.ServiceHistoryID = StaffServiceHistory.ID
						 where TG_PrincipleVacancyNormal.ID='$id'";
