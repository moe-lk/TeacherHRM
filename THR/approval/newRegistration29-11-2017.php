...
//get data from temp table - Start
  ...
  FROM [dbo].[TG_EmployeeRegister] WHERE ID='$RegID'";
    ...
    if ($IsApproved == 'Y') {
        ...
        $sql_tec = "SELECT NIC,SurnameWithInitials,FullName,Title,PerResRef,MobileTel,emailaddr,DOB,GenderCode,EthnicityCode,ReligionCode,CivilStatusCode,CurServiceRef,RecStatus,LastUpdate,UpdateBy,RecordLog,CurResRef,DOFA,DOACAT FROM ArchiveUP_TeacherMast where ID='$TeacherMastID'";
...
WHERE        (ArchiveUP_StaffAddrHistory.ID = '$AddressHistIDCur')";
    ...
    $GSDivisionT = trim($rowCI['GSDivision']);
    ...
    $sqlCurrentApp = "SELECT        CD_CAT2003.Cat2003Name, CD_CensesNo.InstitutionName, CD_ServiceRecType.Description, CD_SecGrades.GradeName, CD_Positions.PositionName, 
                         CD_Service.ServiceName, ArchiveUP_StaffServiceHistory.ID, CONVERT(varchar(20), ArchiveUP_StaffServiceHistory.AppDate, 121) AS AppDate, ArchiveUP_StaffServiceHistory.InstCode
                ...
                <tr>
                    <td colspan="2" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                            ...
                            <tr>
                                ...
                                <td align="left" valign="top"><strong>:</strong></td>
                                <td align="left" valign="top"><?php echo $AppDateCIT ?></td>
                            </tr>
                            <tr>
                                <td align="left" valign="top">&nbsp;</td>
                                <td align="left" valign="top">&nbsp;</td>
