    ...
    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
        ...
        <td width="41%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                ...
                <tr>
					...
					$alreadyInTT=getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumberM,$getTTID,"Monday");
					...
					if(count($exNIC)=='2'){
						...
						?></span><br /><?php //print_r($subjectFirst);?><?php //echo $subjectCodeLoad ?>
							...
							if($groupCheck!=''){
								...
								for($p=0;$p<count($groupCode);$p++){
									...
									if($codeGroup!=''){
										...
										$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$groupFid,$PeriodNumberM,$getTTIDGr,"Monday");
                    ...
                    echo $subjectName=getSubjectNameOnly($SchoolID,$GradeID,$ClassID,$FieldID);
					//$alreadyInTT=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$FieldID,$getTTID);
					$alreadyInTT=getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumberM,$getTTID,"Tuesday");
					...
					if(count($exNIC)=='2'){
						$dropClass="select2a_red";
						$alreadyInTT=$exNIC[0];
					}?></span><br /> <?php //echo $subjectCodeLoad ?>
                         <input type="hidden" name="F<?php echo $FieldID ?>" value="<?php echo $subjectCode ?>" />
							...
							if($groupCheck!=''){
								...
								for($p=0;$p<count($groupCode);$p++){
									...
									if($codeGroup!=''){
										...
										$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$groupFid,$PeriodNumberM,$getTTIDGr,"Tuesday");
                    ...
                    echo $subjectName=getSubjectNameOnly($SchoolID,$GradeID,$ClassID,$FieldID);
					//$alreadyInTT=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$FieldID,$getTTID);
					$alreadyInTT=getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumberM,$getTTID,"Wednesday");
							...
							if($groupCheck!=''){
								...
								for($p=0;$p<count($groupCode);$p++){
									...
									if($codeGroup!=''){
										...
										$getTTIDGr=getTTID($SchoolID,$GradeID,$ClassID,$groupFid); 
										//$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$groupFid,$getTTIDGr);
										$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$groupFid,$PeriodNumberM,$getTTIDGr,"Wednesday");
                    ...
                    echo $subjectName=getSubjectNameOnly($SchoolID,$GradeID,$ClassID,$FieldID);
					//$alreadyInTT=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$FieldID,$getTTID);
					$alreadyInTT=getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumberM,$getTTID,"Thursday");
							...
							if($groupCheck!=''){
								...
								for($p=0;$p<count($groupCode);$p++){
									...
									if($codeGroup!=''){
										...
										$getTTIDGr=getTTID($SchoolID,$GradeID,$ClassID,$groupFid); 
										//$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$groupFid,$getTTIDGr);
										$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$groupFid,$PeriodNumberM,$getTTIDGr,"Thursday");
                    ...
                    echo $subjectName=getSubjectNameOnly($SchoolID,$GradeID,$ClassID,$FieldID);
					//$alreadyInTT=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$FieldID,$getTTID);
					$alreadyInTT=getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumberM,$getTTID,"Friday");
					...
					if(count($exNIC)=='2'){
						$dropClass="select2a_red";
						$alreadyInTT=$exNIC[0];
					} ?></span><br /><?php //if($subjectCodeLoad!='')echo "*"; ?>
                         <input type="hidden" name="F<?php echo $FieldID ?>" value="<?php echo $subjectCode ?>" />
							...
							if($groupCheck!=''){
								...
								for($p=0;$p<count($groupCode);$p++){
									...
									if($codeGroup!=''){
										...
										$getTTIDGr=getTTID($SchoolID,$GradeID,$ClassID,$groupFid); 
										//$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$GradeID,$ClassID,$groupFid,$getTTIDGr);
										$alreadyInTTGr=getAlreadyInTeacher($SchoolID,$groupFid,$PeriodNumberM,$getTTIDGr,"Friday");
                ...
                <tr>
                  <td>&nbsp;<?php print_r($subjectFirst);?></td>
                  <td>&nbsp;</td>
                </tr>
              </table>
    </div>
