...
function check_multiselect(field_name, message) {
  if (form.elements[field_name]) {
	  var myArray="";
   
        
	   for (var i=0; i<document.getElementById(field_name).options.length; i++){
				  if (document.getElementById(field_name).options[i].selected == true)
				   {
					  //alert(document.getElementById('mySelect').options[i].text);
		  myArray += document.getElementById(field_name).options[i].text + ";";
					}
	  }
