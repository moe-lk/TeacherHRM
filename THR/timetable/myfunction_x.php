...
function getAlreadyInTeacher($SchoolID,$FieldID,$PeriodNumber,$getTTID,$Day){
...
global $db ;//= new DBManager();
		...
		while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
			...
			$countTotal="SELECT ID FROM TG_SchoolTimeTable where SchoolID='$SchoolID' and ID!='$getTTID' and TeacherID='$NIC' and PeriodNumber='$PeriodNumber' and Day='$Day' and FieldID='$FieldID'";//and GradeID='$GradeID' and ClassID='$ClassID' 
			//and PeriodNumber='$PeriodNumber' and Day='$Day' 
