...
<div class="main_content_inner_block">
  ...
  order by InstitutionName";
                ...
                <input type="hidden" name="mainID" value="<?php echo $primaryid; ?>" />
                      <select class="select5" id="GradeID" name="GradeID" onchange="Javascript:show_classes('classList',this.options[this.selectedIndex].value,document.frmSavex.SchoolID.value);">
...
FROM            TG_SchoolGrade INNER JOIN
  ...
  FROM [dbo].[CD_Subject] order by SubjectName";
	...
	?><div style="width:70px; float:left; background-color:#D2CBFE; margin:2px;">Grade <?php echo "$Title ($TotalG)"; ?></div><?php }?></td>
                </tr>
                <tr>
                    <td colspan="2" bgcolor="#999999"><table width="100%" cellspacing="1" cellpadding="1">
					  ...
					  $sqlList="SELECT        TG_SchoolSubjectGroup.ID, TG_SchoolSubjectGroup.ClassGrouped, CD_CensesNo.InstitutionName, CD_Subject.SubjectName, TG_SchoolGrade.GradeTitle, 
                         TG_SchoolSubjectGroup.SchoolID
FROM            TG_SchoolSubjectGroup INNER JOIN
                         ...
                         TG_SchoolGrade ON TG_SchoolSubjectGroup.GradeID = TG_SchoolGrade.ID
