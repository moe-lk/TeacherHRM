...
//alert(cmbProvince);
    $.ajax({
        ...
        success: function(data) {
			...
			var ExpectSchool = data[4];
			//var ExpectSchool2 = data[5];
			//var ExpectSchool3 = data[6];
			//var ExpectSchool4 = data[7];
			//var ExpectSchool5 = data[8];

            $('#cmbDistrict').html(dataDistrict);
            $('#cmbZone').html(dataZone);
            $('#cmbSchool').html(dataSchool);
            $('#cmbDivision').html(dataDivision);
			$('#ExpectSchool').html(ExpectSchool);
			$('#ExpectSchool2').html(ExpectSchool);
			$('#ExpectSchool3').html(ExpectSchool);
			$('#ExpectSchool4').html(ExpectSchool);
			$('#ExpectSchool5').html(ExpectSchool);
   ...
   // var txtAccessLevel = $("#txtAccessLevel").val();
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $('#cmbDivision').html(dataDivision);
            //$('#cmbSchool').html(dataSchool);
			$('#ExpectSchool').html(dataSchool);
			$('#ExpectSchool2').html(dataSchool);
			$('#ExpectSchool3').html(dataSchool);
			$('#ExpectSchool4').html(dataSchool);
			$('#ExpectSchool5').html(dataSchool);
        }
    });
    /*if (cmbDistrict != "") {
