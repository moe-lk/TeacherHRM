...
$cat="teacherVacancyNational";
$tblName="TG_TeacherVacancyNational";
$TransferType="TVAN";//teacher vacancy national school
...
$countTotal="SELECT * FROM TG_TeacherVacancyNationalMaster";//where SchoolID='$loggedSchool'
        	...
        	<tr>
			  ...
			  <tr>
                  <td colspan="2" bgcolor="#CCCCCC"><table width="100%" cellspacing="1" cellpadding="1">
					...
					$approvalListSql="SELECT        TG_TeacherVacancyNationalMaster.ID, TG_TeacherVacancyNationalMaster.Title, CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.OpenDate,121) AS OpenDate, CONVERT(varchar(20),TG_TeacherVacancyNationalMaster.EndDate,121) AS EndDate, 
                         TG_TeacherVacancyNationalMaster.VacancyDescription, CD_CensesNo.InstitutionName, CD_CensesNo.IsNationalSchool
FROM            TG_TeacherVacancyNationalMaster INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNationalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool='1'";
