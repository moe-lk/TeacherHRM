...
$TotaRows=$db->rowCount($approvSql);
	...
	$checkAvai="SELECT ID from TG_Request_Approve where RequestType='TransferPrincipleNormal' and RequestID='$id' and ApprovedStatus='A'";
...
WHERE        (TG_Request_Approve.RequestID = '$RequestID') AND (TG_Request_Approve.RequestType = 'TransferPrincipleNormal')
