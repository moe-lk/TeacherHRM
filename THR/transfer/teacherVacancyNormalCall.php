...
$cat="teacherVacancyNormalCall";
$tblName="TG_TeacherVacancyNormalMaster";
...
FROM            TG_TeacherVacancyNormalMaster INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNormalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool!='1' and TG_TeacherVacancyNormalMaster.ID='$id'";
