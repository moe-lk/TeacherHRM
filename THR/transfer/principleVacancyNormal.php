...
$cat="principleVacancyNormal";
$tblName="TG_PrincipleVacancyNormal";
$TransferType="PVANO";//teacher vacancy national school
$approvetype="VacancyPrincipleNormal";

if($fm=='' || $fm=='A'){
	$countTotal="SELECT * FROM TG_PrincipleVacancyNormal";//where SchoolID='$loggedSchool'
...
FROM            TG_PrincipleVacancyNormalMaster INNER JOIN
					...
					$stmtApp = $db->runMsSqlQuery($approvalListSql);
                     while ($rowApp = sqlsrv_fetch_array($stmtApp, SQLSRV_FETCH_ASSOC)) {
						...
						$countTotal = "SELECT * FROM TG_PrincipleVacancyNormal where VacancyMasterID='$RequestID' and NIC='$NICUser'";
