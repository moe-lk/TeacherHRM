...
$cat="principalVacancyNationalMaster";
$tblName="TG_PrincipleVacancyNationalMaster";
...
FROM            TG_PrincipleVacancyNationalMaster INNER JOIN
                         CD_CensesNo ON TG_PrincipleVacancyNationalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool='1' and TG_PrincipleVacancyNationalMaster.ID='$id'";
