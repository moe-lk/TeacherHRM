...
$cat="transferPrincipleNational";
$tblName="TG_PrincipleTransferNational";
$TransferType="PTRN";

if($fm==''){
	$approvSql="SELECT        TG_PrincipleTransferNational.ID, TG_PrincipleTransferNational.TransferRequestType, TG_PrincipleTransferNational.TransferRequestTypeID, TG_PrincipleTransferNational.ExpectSchool, 
                         ...
                         TG_PrincipleTransferNational.IsApproved, CD_CensesNo.InstitutionName, TG_PrincipleTransferNational.TransferType, TG_PrincipleTransferNational.NIC
FROM            TG_PrincipleTransferNational INNER JOIN
                         CD_CensesNo ON TG_PrincipleTransferNational.SchoolID = CD_CensesNo.CenCode
WHERE        (TG_PrincipleTransferNational.IsApproved = 'N') AND (TG_PrincipleTransferNational.NIC ='$NICUser')";

$TotaRows=$db->rowCount($approvSql);

	$checkAvai="SELECT ID from TG_Request_Approve where RequestType='TransferPrincipleNational' and RequestID='$id' and ApprovedStatus='A'";
         ...
         <table width="945" cellpadding="0" cellspacing="0">
        	...
        	<tr>
              <td><?php echo $TotaRows ?> Record(s) found.</td>
                  <td align="right"><a href="principalRequestNational-4---A.html">Add New</a></td>
           </tr>
			  <tr>
...
WHERE        (TG_Request_Approve.RequestID = '$RequestID') AND (TG_Request_Approve.RequestType = 'TransferPrincipleNational')
...
while ($row = sqlsrv_fetch_array($stmtFA, SQLSRV_FETCH_ASSOC)) {
	echo $currentAppDate=$row['currentAppDate'];
                    ...
                    <tr>
                      <td align="left" valign="top" bgcolor="#F7E2DD">Teaching Subjects :</td>
