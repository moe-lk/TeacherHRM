...
$cat="teacherVacancyNationalMaster";
$tblName="TG_TeacherVacancyNationalMaster";
...
FROM            TG_TeacherVacancyNationalMaster INNER JOIN
                         CD_CensesNo ON TG_TeacherVacancyNationalMaster.SchoolID = CD_CensesNo.CenCode where CD_CensesNo.IsNationalSchool='1' and TG_TeacherVacancyNationalMaster.ID='$id'";
