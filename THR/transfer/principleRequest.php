...
$cat="transferPrinciple";
$tblName="TG_PrincipleTransfer";
$TransferType="PTR";
$approvetype="TransferPrincipleNormal";


if($fm==''){
	$approvSql="SELECT        TG_PrincipleTransfer.ID, TG_PrincipleTransfer.TransferRequestType, TG_PrincipleTransfer.TransferRequestTypeID, TG_PrincipleTransfer.ExpectSchool, 
                         ...
                         TG_PrincipleTransfer.IsApproved, CD_CensesNo.InstitutionName, TG_PrincipleTransfer.TransferType, TG_PrincipleTransfer.NIC
FROM            TG_PrincipleTransfer INNER JOIN
                         CD_CensesNo ON TG_PrincipleTransfer.SchoolID = CD_CensesNo.CenCode
WHERE        (TG_PrincipleTransfer.IsApproved = 'N') AND (TG_PrincipleTransfer.NIC ='$NICUser')";
        ...
        <tr>
            ...
            <tr>
        	    <td><table width="100%" cellspacing="1" cellpadding="1">
                 ...
                 <?php if($fm=='DAD'){?>
        	      <tr>
        	        <td width="22%" bgcolor="#CFF1D1">Request Type :</td>
        	        <td width="78%" bgcolor="#CFD7FE"><select name="TransferRequestType" class="select2a_n" id="TransferRequestType" onchange="showSchoolTransferDet()">
        	      ...
        	      <tr>
                    ...
                    <tr>
                      <td valign="top" width="22%" bgcolor="#CFF1D1">Extra Activities :</td>
