...
class nusoap_base {
    ...
    var $namespaces = array(
        ...
        'v1' => 'http://schemas.icta.lk/xsd/kannel/handler/v1/'
    );
...
class soap_transport_http extends nusoap_base {
    ...
    function soap_transport_http($url, $curl_options = NULL, $use_curl = false) {
        ...
        //Changed
        //preg_replace('\$Revisio' . 'n: ([^ ]+)', $this->revision, $rev);
    ...
    function invoke_method() {
        ...
        if ($class == '') {
            if (!function_exists($this->methodname)) {
                ...
                $this->fault('soapenv:Client', "method '$this->methodname' not defined in service");
                return;
            }
        } else {
