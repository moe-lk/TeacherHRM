                                    ...
                                    <div class="midArea"> 
                                        <div class="productsAreaRight">
                                            <ul id="menu" class="menu">
                                                <!--<li <?php if($pageid==1 || $pageid==0){?>class="active"<?php }?>><a href="teacherQualification-1.html">Qualification submit </a></li>-->
                                               
                                                <li <?php if($pageid==2 || $pageid==0){?>class="active"<?php }?>><a href="requestTraining-2.html">Request a Training</a></li>
                                                <li <?php if($pageid==4 ){?>class="active"<?php }?>><a href="applyForTraining-4.html">Apply for Training</a></li>
                                                <li <?php if($pageid==3 ){?>class="active"<?php }?>><a href="callATraining-3.html">Trainings</a></li>
...
<div id="geographical" class="contenttab"></div>
                                ...
                                <?php //echo $pageid;
								//if($pageid==1 || $pageid==0)include('teacherQualification.php');					
								if($pageid=='2' || $pageid==0)include('requestTraining.php');
								if($pageid=='2a')include('requestTrainingSessions.php');
								if($pageid=='3')include('callATraining.php');
								if($pageid=='4')include('applyForTraining.php');
								?>
                                </div>
                                </div>
                            </div>
