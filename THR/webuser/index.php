      ...
      <div id="header_top">
       	<div class="header_top_left">&nbsp;&nbsp; </div>
            <div class="header_top_right">
           		<div id="admin_button" style="cursor:default;"><a href="#" id="admin_link" style="cursor:default;"><span style="cursor:default;"><?php if($loggedPositionName){echo $loggedPositionName;}else{echo "Anonymous user";}?></span></a></div>
               <!-- <div id="mail_button"><a href="#"></a><div id="mail_alert" class="alert">05</div></div>-->
               <?php if($NICUser){?><div id="user_welcome">Welcome <?php echo $_SESSION["fullName"]; ?>, &nbsp;&nbsp; <span class="link1" onClick="logoutForm('mail');">Logout?</span></div><?php }else{?><div id="user_welcome">Welcome</div><?php }?>
            </div>
        </div>
                    ...
                    <div id="main_content_inner">
                        ...
                        <div class="main_content_inner_block">
                            ...
                            <div class="mcib_middle">
                                ...
                                <?php //echo $pageid;
								if($pageid == 0)include('coordinatorsList.php');
								if($pageid == 1)include('contactUs.php');
