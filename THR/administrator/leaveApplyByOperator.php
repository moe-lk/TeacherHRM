...
FROM            TG_StaffLeave INNER JOIN
						 ...
						 where TG_StaffLeave.SchoolID='$loggedSchool' and TG_StaffLeave.ApplyBy='OPERATOR'";//$NICUser
...
if(isset($_POST["FrmSubmit"])){	
	...
	$RecordLog="Apply by Operator on $LastUpdate";
	$IsApproved="N";
	$ApplyBy="OPERATOR";
                  ...
                  <td width="56%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                    <tr>
                      ...
                      <td><?php //echo $NICUser ?><select class="select2a_n" id="NIC" name="NIC">
                            <?php
                            $sql = "SELECT NIC, TeacherName      
  FROM TG_SchoolTimetableTeachersTemp
  where SchoolID='$loggedSchool'";
                            $stmt = $db->runMsSqlQuery($sql);
                            while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                echo '<option value=' . $row['NIC'] . '>' . $row['TeacherName'] . '</option>';
                            }
                            ?>
                      </select>
                      <?php 
        ...
        <td width="44%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                ...
                <tr>
                  ...
                  <td rowspan="4" valign="top"><textarea name="Reference" cols="45" rows="5" class="textarea1auto" id="Reference"></textarea></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2" bgcolor="#CCCCCC"><table width="100%" cellspacing="1" cellpadding="1">
                      <tr>
                        ...
                        <td width="24%" align="center" bgcolor="#999999">Teacher Name</td>
