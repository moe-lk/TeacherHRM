...
function updateNIC($conn, $stmt1, $stmt2, $stmt3, $stmt4, $stmt5, $stmt6, $stmt7, $stmt8, $sql1, $sql2, $sql3, $sql4, $sql5, $sql6, $sql7, $sql8, $params1, $params2, $params3, $params4, $params5, $params6, $params7, $params8, $newnic, $connic, $NICSrch){
        ...
        elseif($newnic == $connic){
            ...
            if (strlen($newnic) == 10) {   
                ...
                if (($result == $newnic[8]) && (($newnic[9] == 'v') || ($newnic[9] == 'x') || ($newnic[9] == 'V')||($newnic[9] == 'X'))) { // compare with check digit at 9th position and V or X in 10th position
                    ...
                    <?php
                        updateNIC($conn, $stmt1, $stmt2, $stmt3, $stmt4, $stmt5, $stmt6, $stmt7, $stmt8, $sql1, $sql2, $sql3, $sql4, $sql5, $sql6, $sql7, $sql8, $params1, $params2, $params3, $params4, $params5, $params6, $params7, $params8, $newnic, $connic, $NICSrch);    
                }
                else{
                    ?>
                        <script type="text/javascript">
            ...
            elseif (strlen($newnic) == 12) {
                ...
                if ($result == $newnic[11]) { // compare with check digit at 12th position
                    // At this point, we have a valid NIC
                    ?>
                    <script>
                    var txt;
            ...
            <table width="945" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <table width="90%" cellspacing="2" cellpadding="2">
                            <tr>
                                ...
                                <td width="63%"><input name="FrmSrch" type="submit" id="FrmSrch" style="background-image: url(../cms/images/findteacher.png); width:130px; height:26px; background-color:transparent; border:none; cursor:pointer;" value="" /></td>
                            </tr>
                    </table>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <?php
                        if ($NICSrch != '') {
                            if ($CurPassword == '') {
                            ?>
                                <span style="color:#F00; font-weight:bold;">Teacher does not exist.</span>
                            <?php 
                            }
                            elseif ($CurPassword != '' && $show_status== TRUE && in_array($AccessID, array_map("trim", explode(',', $SeeControlLevel)))) {

                            }
                            else{
                                echo "<span style='color:#F00; font-weight:bold;'>Teacher does not belongs to your zone.</span>";
                            }
                        }
                    ?>
                    </td>
                ...
                <tr>
                    ...
                    <td width="38%" valign="top">
                        ...
                        <tr>
                            <td align="left" bgcolor="#FFFFFF"><a style="cursor:hand; cursor:pointer; border-bottom:1px; border-bottom-style:solid; color:#FFF;" onclick="Javascript:show_changenic('change_nic', '', '');">
                                <img src="../cms/images/change-nic.jpg" width="150" height="26" /></a><input type="hidden" name="insertTyp" value="E" />
                            </td>
                        </tr>
                        <?php } ?>
                            <tr>
                                <td width="48%">
                                    <div id="txt_changenic">
                                        <?php if($CurPassword=='DAD'){?>
