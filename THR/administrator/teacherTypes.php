...
if(isset($_POST["FrmSubmit"])){	
	...
	if($Title!=''){
		...
		$countSql="SELECT * FROM $tblNam where Title='$Title'";
        ...
        <table width="945" cellpadding="0" cellspacing="0">
			  <tr>
                  <td width="56%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                      <td>Title <span class="form_error">*</span>:</td>
        ...
        <td width="44%" valign="top"><table width="100%" cellspacing="2" cellpadding="2">
                ...
                <tr>
                    <td colspan="2" bgcolor="#CCCCCC"><table width="100%" cellspacing="1" cellpadding="1">
                      <tr>
                        <td width="8%" height="25" align="center" bgcolor="#999999">#</td>
                        <td width="61%" align="center" bgcolor="#999999">Teacher Type</td>
                        <td width="31%" align="center" bgcolor="#999999">Delete</td>
                      </tr>
                      <?php 
					  $sqlList="SELECT * From $tblNam where ID>'0'";
					  /*$sqlList="SELECT [ID]
      ,[SchoolID]
      ,[GradeID]
