    ...
    <body>
        <div class="wrapper"><!-- wrapper -->
            ...
            <div class="midOutBox"><!-- midOutBox -->
                <!-- <div class="midBox" style="padding: 10px;
    background-color: #999;
    border-radius: 5px;
    text-align: center;
    margin-top: 15px; color:#92495C;
    font-size: 20px;">Due to maintenance work at the IDC of the service provider, NEMIS system will not be available <br> form 4PM on 26 April 2018 to 10AM on 27 April 2018.</div> -->
                <div class="midBox"><!-- midBox -->
                    <div class="midLeftBox"><!-- midLeftBox -->
                        <div class="proBox">
                            <div class="proBoxTitel">Honorable Minister</div>
                            <div class="proBoxImg"><img src="images/akila.png" width="210" height="110"></div>
                        ...
                        <div class="proBox">
                            ...
                            <div class="proBoxImg"><img src="images/radhakrishnan.png" width="210" height="110"></div>
...
<!--<div class="midImg"><img src="images/pro-2.jpg" width="445" height="280"></div>-->
                        ...
                        <div class="midBoxText">
                            <div class="midTextTitel">Welcome to NEMIS<br>[Teacher HRM Portal]</div>
                            <div class="midTextBox">National Education Management Information System, abbreviated as NEMIS, is an online web portal that automates the entire end-to-end management of education data and related administration functions. <br><br>
                                ...
                                At present the NEMIS is focused to the Teacher Human Resource Management aspect and it is expected to develop other modules which handle basically all the entities related to education including students, teachers, principals, schools, educational offices at zonal and provincial levels and the Ministry of Education. <br><br>
