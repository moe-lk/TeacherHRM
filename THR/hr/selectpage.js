...
function show_salaryscale(str,icid,srch)
{ //alert(icid);
var url="getpage.php?sid=" + Math.random() + "&q=" + str + "&iCID=" + icid + "&srch=" + srch	
xmlHttp=GetXmlHttpObject(show_salaryscaleTxt)
xmlHttp.open("GET", url , true)
xmlHttp.send(null)
} 

function show_salaryscaleTxt()
{ 
if (xmlHttp.readyState==4 || xmlHttp.readyState=="complete")
{ 
document.getElementById("txt_salaryscale").innerHTML=xmlHttp.responseText 
} 
}
//getSubCatID
