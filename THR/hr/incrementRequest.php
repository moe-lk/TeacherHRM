	...
	if($countProcx!='0'){
		...
		$queryRegis = "INSERT INTO TG_IncrementRequest				   (NIC,ServCode,SalaryScale,CurrentSalaryStep,EffectiveDate,IsApproved,UpdateBy,LastUpdate,RecordLog,SchoolID,AttachFile)
			...
			//echo $queryRegis;
					...
					$sms_content = 'Increment request submitted successfully';
					...
					//end SMS
					$queryRegissms = "INSERT INTO TG_SMS (NIC,ModuleName,dDateTime,StatusOf,RecID) VALUES ('$NIC','Increment Request','$dateU','$statusOf','$newID')";
