...
$search = $_POST['search'];
if ($search == "Y") {
    $cmbCivilStatusID = trim($_POST['cmbCivilStatus']);
}
//exit();
?>
        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Civil Status</strong></label></div>
                ...
                <div class="row">
                    <div class="column" >
                        <div style="width: 35%;float: left;margin-top: 5px; margin-left: 22px;">Civil Status :</div>
                        <div  style="margin-left:22px;">
                            <select class="selectRpt" style="width:260px;" id="cmbCivilStatus" name="cmbCivilStatus" >
                                ...
                                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                    ...
                                    if ($cmbCivilStatusID  == trim($Code)) {
                                        echo '<option selected="selected" value=' . $Code . '>' . $CivilStatusName . '</option>';
                                    } else {
                                        echo '<option value=' . $Code . '>' . $CivilStatusName . '</option>';
                                    }
                                }
                                ?>
                            </select>
...
<script type="text/javascript">
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generateCivilStatus.php';
