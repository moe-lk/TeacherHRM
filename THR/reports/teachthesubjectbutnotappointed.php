        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Teach the Subject but not Appointed</strong></label></div>
...
<script type="text/javascript">
            ...
            (
                    {
                        ...
                        usepager: true,
                        title: 'Teach the Subject but not Appointed',
                        useRp: true,
                        rp: 20,
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generateTeachtheSubjectbutnotAppointed.php';
