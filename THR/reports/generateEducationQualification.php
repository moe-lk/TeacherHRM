...
$cmbQualification = $_REQUEST["cmbQualification"];
...
WHERE
CD_QualificationCategory.Code = '$cmbQualification'";
    $stmt6 = $db->runMsSqlQuery($sql6);
...
School Status : " . $schoolStatus . "</br> School : ". $schoolName ."</br> Qualification Category :  ". $Description ."</br> Subject :  ". $subjectName ."</div>";
...
if ($cmbQualification != "All") {
    $sql .= " AND CD_QualificationCategory.Code = '$cmbQualification'";
}
if ($cmbSubject != "All") {
