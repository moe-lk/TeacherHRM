...
$cmbFunctionalGradeID = $_POST['cmbFunctionalGradeID'];
...
if ($cmbFunctionalGradeID != "All") {
    $sql .= " AND CD_SecGrades.GradeCode = '$cmbFunctionalGradeID'";
}
if ($cmbSchoolStatus != "") {
...
if ($cmbFunctionalGradeID != "All") {
    $sqlCount .= " AND CD_SecGrades.GradeCode = '$cmbFunctionalGradeID'";
}
if ($cmbSchoolStatus != "") {
