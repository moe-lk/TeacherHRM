...
$ModuleFolder = $exUrl[$folderLocation];
   ...
   */
     // window.open('https://www.codexworld.com', '_blank');
       ...
       header("Location:quickreport-$reportT.html");
                        ...
                        <div class="mcib_middle">
                            ...
                            <div class="containerHeaderOne">
                                ...
                                <div style="width:945px; height:auto; float:left; margin-left:10px;">
                                    ...
                                    if ($pageid == 2) {
                                        include('educationqualification.php');
                                    }

                                    if ($pageid == 3) {
                                        include('mediumofinstuction.php');
                                    }
                                    if ($pageid == 4) {
                                        include('agegroup.php');
                                    }
                                    if ($pageid == 5) {
                                        include('servicecategory.php');
                                    }
                                    if ($pageid == 6) {
                                        include('functionalgrade.php');
                                    }
                                    if ($pageid == 7) {
                                        include('teachthesubjectbutnotqualified.php');
                                    }
                                    if ($pageid == 8) {
                                        include('teachthesubjectbutnotappointed.php');
                                    }
                                    if ($pageid == 9) {
                                        include('retirement.php');
                                    }
                                    if ($pageid == 10) {
                                        include('durationinthesameschool.php');
                                    }
                                    if ($pageid == 11) {
                                        include('civilstatus.php');
                                    }
                                    if ($pageid == 12) {
                                        include('servicerec.php');
                                    }
                                    if ($pageid == 13) {
                                        include('promotionrec.php');
                                    }
