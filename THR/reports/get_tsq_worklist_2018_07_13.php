...
select Distinct NIC
 ...
 $sql .= "TeacherSubject.SubjectType = 'APP'";
  )

select Distinct TeacherMast.NIC, TeacherMast.SurnameWithInitials, CD_CensesNo.InstitutionName
  from TeacherMast
...
if ($cmbSubjectID != "All") {
    $sqlCount .= " AND CD_QualificationCategory.Code = '$cmbSubjectID'";
}
if ($cmbSchoolStatus != "") {
