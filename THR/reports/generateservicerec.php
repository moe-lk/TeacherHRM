...
$html .= "<td class=\"thHeading\" width=\"10%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">Zone</td> ";
...
$sql .= ") ORDER BY TeacherMast.NIC,StaffServiceHistory.AppDate"; 
...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    ...
    $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $row['ZoneName'] . "</td> ";
