...
$cmbMediumID = $_POST['cmbMediumID'];
$cmbSubjectID = $_POST['cmbSubjectID'];
$cmbGenderID = $_POST['cmbGenderID'];
...
if ($cmbMediumID != "All") {
    $sql .= " AND TeacherSubject.MediumCode = '$cmbMediumID'";
}
if ($cmbSubjectID != "All") {
    $sql .= " AND CD_Subject.SubCode = '$cmbSubjectID'";
}
if ($cmbGenderID != "All") {
    $sql .= " AND CD_Gender.GenderCode = '$cmbGenderID'";
}
if ($cmbSchoolStatus != "") {
...
if ($cmbMediumID != "All") {
    $sqlCount .= " AND TeacherSubject.MediumCode = '$cmbMediumID'";
}
if ($cmbGenderID != "All") {
    $sqlCount .= " AND CD_Gender.GenderCode = '$cmbGenderID'";
}
if ($cmbSubjectID != "All") {
