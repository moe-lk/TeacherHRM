...
$search = $_POST['search'];
if ($search == "Y") {
    $cmbRetirementID = trim($_POST['cmbRetirement']);
}
//exit();
?>
<?php
    ...
    <div id="geographical" class="contenttab">
        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div class="row">
                    <div class="column" >
                      <div style="width: 35%;float: left;margin-top: 5px; margin-left: 22px;">Retirement Date :</div>
                      <div  style="margin-left:22px;">

                  <?php
                        echo "<select id=\"t1\" name=\"cmbRetirement\" class=\"selectRpt\" style=\"width:260px\" onchange=\"setlastitem()\">";
                        $retirementD = array(All => 'All',$sysDate => $sysDate);
                        foreach ($retirementD as $key => $value) {
                          if ($key == $_POST['cmbRetirement']){
                    ...
                    <div class="column2">
                      <div style="width: 17%; margin-top: 2px; float: left;">Enter a Date :</div>
                      <div >
                            <input type="date" class="input3" id="newSchool">
                            <input style="margin-top:0px !important;background-color: #92495C;font-size: 12px;
                                   color: #fff;padding: 4px; margin-left: 20px;
                                   border: none; width: 80px; font-weight: bold;" type="button" onclick="addtext();" name="srchBtt" id="addSchool" value="Insert"/>
