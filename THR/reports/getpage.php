...
if($q=='districtList'){
	$details="<select  class=\"selectRpt\" id=\"cmbDistrict\" name=\"cmbDistrict\" onchange=\"Javascript:show_zone('zonelist', this.options[this.selectedIndex].value,'');\">
...
if($q=='zonelist'){
	$details="<select class=\"selectRpt\" id=\"cmbZone\" name=\"cmbZone\" onchange=\"Javascript:show_division('divisionList', this.options[this.selectedIndex].value,'$iCID');\">
			  <option value=\"\">-Select-</option>";
...
if($q=='divisionList'){
	$details="<select class=\"selectRpt\" id=\"cmbDivision\" name=\"cmbDivision\" onchange=\"Javascript:show_cences('censesList', this.options[this.selectedIndex].value,'$iCID');\">
			  <option value=\"\">-Select-</option>";
...
if($q=='censesList'){
    ...
    $details="<select class=\"selectRpt\" id=\"cmbSchool\" name=\"cmbSchool\">
			  <option value=\"\">-Select-</option>";
