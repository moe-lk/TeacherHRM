...
$search = $_POST['search'];
if ($search == "Y") {
    $cmbFirstValueID = trim($_POST['cmbFirstValue']);
    $cmbSecondValueID = trim($_POST['cmbSecondValue']);
}
//exit();
?>
        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Age Group</strong></label></div>
                ...
                <div class="row">
                    <div class="column" >
                        <div style="width: 15%;float: left;margin-top: 5px; margin-left: 22px;">First Value :</div>
                        <div  style="margin-left:22px;">
                                <?php
                                echo "<select name=\"cmbFirstValue\" class=\"selectRpt\" style=\"width:260px\">";
                                $FirstValue = array(All => 'All',1 => '1', 20 => '20', 26 => '26', 31 => '31', 36 => '36', 41 => '41', 46 => '46',51 => '51',56 => '56',60 => '60');
                                foreach ($FirstValue as $key => $value) {
                                  if ($key == $_POST['cmbFirstValue']){
                    ...
                    <div class="column2">
                        <div style="width: 17%; margin-top: 2px; float: left;">Second Value :</div>
                        <div >
                          <?php
                          echo "<select name=\"cmbSecondValue\" class=\"selectRpt\" style=\"width:250px;float:left\" >";
                          $SecondValue = array(All => 'All',20 => '20', 25 => '25', 30 => '30', 35 => '35', 40 => '40', 45 => '45', 50 => '50',55 => '55',60 => '60',65 => '65');
                          foreach ($SecondValue as $key => $value) {
                            if ($key == $_POST['cmbSecondValue']){
                              $selected = "selected=\"selected\""; } else { $selected = ""; }
                              echo "<option value=\"$key\" $selected>$value</option>";
                            }
                            echo "</select>";
...
<script type="text/javascript">
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generateAgeGroup.php';
