...
$search = $_POST['search'];
if ($search == "Y") {
    $cmbQualificationID = trim($_POST['cmbQualification']);
        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Education Qualification</strong></label></div>
                ...
                <div class="row">
                    <div class="column" >
                        <div style="width: 35%;float: left;margin-top: 5px; margin-left: 22px;">Qualification Category :</div>
                        <div  style="margin-left:22px;">
                            <select class="selectRpt" style="width:260px;" id="cmbQualification" name="cmbQualification" >
                                <option value="All">All</option>
                                <?php
                                $sql = "SELECT
                                CD_QualificationCategory.Code,
                                CD_QualificationCategory.Description
                                FROM
                                CD_QualificationCategory
                                ORDER BY
                                Description ASC";
                                ...
                                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                    ...
                                    if ($cmbQualificationID  == trim($Code)) {
...
<script type="text/javascript">
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generateEducationQualification.php';
