...
$rtDate = $_REQUEST['rtDate'];
$rtDate2 = $_REQUEST['rtDate2'];
...
$html.="<div style=\"height:135px; font-size:18px; font-weight:600; width:65%;float: left;\">
School Type :" . $schType . "</br>Province : " . $provinceName . "</br>District : " . $districtName . "</br>Zone : " . $zoneName . "</br>Division : " . $divisionName ."</div>";

$html.="<div style=\"height:235px; font-size:18px; font-weight:600; float : right;width:35%\">
School Status : " . $schoolStatus . "</br>School : ". $schoolName ."</br>Retirement Date From:  ". $retirementD ."</br>Retirement Date To:  ". $retirementD2."</div>";
...
$html .= "<td class=\"thHeading\" width=\"5%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">Retirement Date</td> ";
$html .= "</tr>";
...
CD_CensesNo.InstitutionName, DOB
FROM
TeacherMast
...
if ( ! empty($rtDate2)){
    // $sql .= " AND DATEDIFF(hh,DOB,'$rtDateID2') >='525960'";
    $sql .= " AND DATEADD(year, -60, '$rtDate2') >= DOB";
}
if ( ! empty($rtDate)){
    //   $sql .= " AND DATEDIFF(hh,DOB,'$rtDateID') <='525960'";
    $sql .= " AND DATEADD(year, -60, '$rtDate') <= DOB";
}
if ($cmbSchoolStatus != "") {
...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    ...
    $html .= "<td width=\"5%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $DRT->format('Y-m-d') . "</td> ";
