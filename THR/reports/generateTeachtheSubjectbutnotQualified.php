...
School Status : " . $schoolStatus . "</br>School : ". $schoolName ."</br>Subject :  ". $SubjectName ."</div>";
...
where  CD_Subject.SubCode = '$cmbSubject' AND CD_SubjectTypes.SubType = 'APP')";
...
$sql .= " AND CD_Subject.SubCode = '$cmbSubject'";
}
if ($cmbSchoolStatus != "") {
