...
$cmbRetirement = $_REQUEST["cmbRetirement"];
...
if (!empty($cmbRetirement)) {

    $retirementD = $cmbRetirement;
} else {
    $retirementD = "All";
}
...
School Status : " . $schoolStatus . "</br>School : ". $schoolName ."</br>Retirement Date :  ". $retirementD ."</div>";
...
if ($cmbRetirement != "All") {
    $sql .= " AND DATEDIFF(YY,DOB,'$cmbRetirement') >='60'";
}
if ($cmbSchoolStatus != "") {
