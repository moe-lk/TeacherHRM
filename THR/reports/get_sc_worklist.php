...
$cmbCategoryID = $_POST['cmbCategoryID'];
$cmbPositionID = $_POST['cmbPositionID'];
...
if ($cmbCategoryID != "All") {
    $sql .= " AND CD_Service.ServCode = '$cmbCategoryID'";
}
if ($cmbPositionID != "All") {
    $sql .= " AND CD_Positions.Code = '$cmbPositionID'";
}
...
if ($cmbCategoryID != "All") {
    $sqlCount .= " AND CD_Service.ServCode = '$cmbCategoryID'";
}
if ($cmbPositionID != "All") {
    $sqlCount .= " AND CD_Positions.Code = '$cmbPositionID'";
}
if ($cmbSchoolStatus != "") {
