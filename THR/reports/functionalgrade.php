...
$search = $_POST['search'];
if ($search == "Y") {
    $cmbFunctionalGradeID = trim($_POST['cmbFunctionalGrade']);
}
//exit();
?>
        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Functional Grade</strong></label></div>
                ...
                <div class="row">
                    <div class="column" >
                        <div style="width: 35%;float: left;margin-top: 5px; margin-left: 22px;">Functional Grade :</div>
                        <div  style="margin-left:22px;">
                            <select class="selectRpt" style="width:260px;" id="cmbFunctionalGrade" name="cmbFunctionalGrade" >
                                <option value="All">All</option>
                                <?php
                                $sql = "SELECT
                                CD_SecGrades.GradeCode,
                                ...
                                while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                                    ...
                                    if ($cmbFunctionalGradeID  == trim($GradeCode)) {
                                        echo '<option selected="selected" value=' . $GradeCode . '>' . $GradeName . '</option>';
                                    } else {
...
<script type="text/javascript">
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generateFunctionalGrade.php';
