...
$cmbCivilStatusID = $_POST['cmbCivilStatusID'];
...
if ($cmbCivilStatusID != "All") {
    $sql .= " AND CD_CivilStatus.Code = '$cmbCivilStatusID'";
}
if ($cmbSchoolStatus != "") {
...
if ($cmbCivilStatusID != "All") {
    $sqlCount .= " AND CD_CivilStatus.Code = '$cmbCivilStatusID'";
}
if ($cmbSchoolStatus != "") {
