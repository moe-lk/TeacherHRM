...
$cmbDurationSS = $_REQUEST["cmbDurationSS"];
...
if (!empty($cmbDurationSS)) {

    $durationSS = $cmbDurationSS;
} else {
    $durationSS = "All";
}

/*need to delete this code block
...
School Status : " . $schoolStatus . "</br>School : ". $schoolName ."</br>";

if($svDateID==""){
    $html.= "To date :  ". date('Y/m/d') ."";
}
else{
    $html.= "To date :  ". $svDateID ."";
}
if($durat ==""){
    $html.= "<br>Duration :  All ";
}
else{
    $html.= "<br>Duration greater than:  ". $durat ." year(s)";
}
$html .= "</div></br><div style=\"width:100%; font-size:14px; font-weight:600; margin-top:0px; margin-right:15px;\"><label> Generated by -  " . $_SESSION["fullName"] ." on ".date('Y-m-d H:i:s') . "</label></div><br>";
...
$html .= "<td class=\"thHeading\" width=\"10%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">From date</td> ";
$html .= "<td class=\"thHeading\" width=\"10%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">Dur(Y)</td> ";
$html .= "<td class=\"thHeading\" width=\"10%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">Dur(M)</td> ";
$html .= "<td class=\"thHeading\" width=\"10%\" align=\"center\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">Dur(D)</td> ";
$html .= "</tr>";
...
while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
    $AppDate = $row['AppDate'];
    // var_dump($row['DateMax']);
    $Duration = date_diff(date_create(date("M j, Y")) ,$AppDate);
    $TDuration = date_diff(date_create($svDateID), $AppDate);
    $html .= "<tr>";
    ...
    $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $AppDate->format('Y/m/d') . "</td> ";
    if($svDateID==""){
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $Duration->format('%y') . "</td> ";
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $Duration->format('%m') . "</td> ";
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $Duration->format('%d') . "</td> ";
    }
    else{
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $TDuration->format('%y') . "</td> ";
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $TDuration->format('%m') . "</td> ";
        $html .= "<td width=\"10%\" style=\"border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-top: 1px solid #000000; border-right:1px solid #000000;\">" . $TDuration->format('%d') . "</td> ";
    }
