        ...
        <form id="frmReport" name="frmReport" action="" method="post" enctype="multipart/form-data" >
            <div class="productsItemBoxText">
                ...
                <div style="height: 51px;">
                    ...
                    <div style="float: left;width: 279px; height:40px"><label for="username" class="labelTxt" style="margin-left:22px;"><strong>Promotion Records</strong></label></div>
...
<script type="text/javascript">
            ...
            (
                    {
                        ...
                        colModel: [
                            ...
                            {display: 'ServiceGrade', name: 'ServiceGrade', width: 130, sortable: true, align: 'left'},
                            ...
                            {display: 'To Date', name: 'To Date', width: 85, sortable: true, align: 'left'},
                            {display: 'Duration', name: 'Duration', width: 55, sortable: true, align: 'left'}
    ...
    function submitForm() {
        if (!$("input[name='rExportXLS']").is(':checked')) {
            ...
            document.getElementById('frmReport').action = 'generatepromotionrec.php';
