...
$cmbFirstValue = $_REQUEST["cmbFirstValue"];
$cmbSecondValue = $_REQUEST["cmbSecondValue"];
...
if (!empty($cmbFirstValue)) {
  $FirstValue = $cmbFirstValue;
...
if (!empty($cmbSecondValue)) {
  $SecondValue = $cmbSecondValue;
...
School Status : " . $schoolStatus . "</br> School : ". $schoolName ."</br> Age between :  ". $FirstValue ."</br> And   ". $SecondValue ."</div>";
...
if ($cmbSecondValue != "All") {
    $sql .= " AND DATEDIFF(YY,DOB,'$sysDate') between '$cmbFirstValue' and '$cmbSecondValue'";
}
if ($cmbFirstValue != "All") {
    $sql .= " AND DATEDIFF(YY,DOB,'$sysDate') between '$cmbFirstValue' and '$cmbSecondValue'";
}
if ($cmbSchoolStatus != "") {
